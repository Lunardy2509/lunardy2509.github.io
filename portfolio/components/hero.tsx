    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-600 mb-6">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            I craft beautiful, functional, and user-centered digital experiences with{" "}
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="p-2 rounded-full bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg">
